...
bool gen8_wm_kernel__yuv_packed(struct brw_compile *p, int dispatch_width);
bool gen8_wm_kernel__yuv_planar(struct brw_compile *p, int dispatch_width);
bool gen8_wm_kernel__yuv_nv12(struct brw_compile *p, int dispatch_width);
